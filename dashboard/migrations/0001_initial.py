    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('token_pair_reserves', models.FloatField(blank=True, null=True)),
                ...
                ('ll_ratio', models.FloatField(blank=True, default=0, null=True)),
                ('ll_worth_by_weth', models.FloatField(blank=True, default=0, null=True)),
                ('liquidity', models.FloatField(blank=True, default=0, null=True)),
                ('security_issues', models.JSONField(blank=True, default=list, null=True)),
