    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active_account', models.CharField(choices=[('account_hedge', 'account_hedge'), ('account_dex', 'account_dex'), ('account_ajax', 'account_ajax'), ('account_eagle', 'account_eagle'), ('account_ranger', 'account_ranger'), ('account_lion', 'account_lion'), ('account_tiger', 'account_tiger')], default='account_hedge')),
                ...
                ('aave_user_account_data', models.JSONField(blank=True, default=dict, help_text='results from aave contract method for user data is stored here', null=True)),
                ...
                ('command_function', models.TextField(blank=True, default='', null=True)),
                ('command_arguments', models.JSONField(blank=True, default=dict, null=True)),
                ('INDICATORS', models.JSONField(blank=True, default=list, null=True)),
                ('MINUTES', models.JSONField(blank=True, default=list, null=True)),
                ('live_indicators', models.JSONField(blank=True, default=dict, null=True)),
                ('active_time_frame_minutes', models.IntegerField(default=1)),
                ('active_time_frame_length', models.IntegerField(default=1440)),
                ('vision', models.JSONField(blank=True, default=dict, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('contract', models.TextField(blank=True, null=True, unique=True)),
                ('event_block_number', models.BigIntegerField(blank=True, null=True)),
                ('pair_creation_epoch', models.BigIntegerField(blank=True, null=True)),
                ('pair_address', models.TextField(blank=True, null=True)),
                ('name', models.TextField(blank=True, null=True)),
                ('decimals', models.IntegerField(blank=True, null=True)),
                ('symbol', models.TextField(blank=True, null=True)),
                ('total_supply', models.FloatField(blank=True, null=True)),
                ('weth_idx_in_pair', models.IntegerField(blank=True, null=True)),
                ('epoch_created', models.BigIntegerField(blank=True, null=True)),
                ('weth_pair_reserves', models.FloatField(blank=True, null=True)),
                ('price_per_weth', models.FloatField(blank=True, null=True)),
                ('volume', models.FloatField(blank=True, default=0, null=True)),
                ('uncx_user', models.TextField(blank=True, null=True)),
                ('uncx_token_amount', models.FloatField(blank=True, default=0, null=True)),
                ('uncx_pool_lock_ratio', models.FloatField(blank=True, default=0, null=True)),
                ('uncx_epoch_start_lock', models.BigIntegerField(blank=True, default=0, null=True)),
                ('uncx_epoch_end_lock', models.BigIntegerField(blank=True, default=0, null=True)),
                ('go_plus_lp_total_supply', models.FloatField(blank=True, default=0, null=True)),
                ('go_plus_locked_lp_ratio', models.FloatField(blank=True, default=0, null=True)),
                ('go_plus_dex_liquidity', models.FloatField(blank=True, default=0, null=True)),
                ('go_plus_security_issues', models.JSONField(blank=True, default=list, null=True)),
                ('keep_investigating', models.BooleanField(blank=True, default=True, null=True)),
                ('epoch_investigated', models.BigIntegerField(blank=True, default=0, null=True)),
                ('investigation_pass', models.BooleanField(blank=True, default=False, null=True)),
                ...
                ('show_on_chart', models.BooleanField(blank=True, default=True, null=True)),
                ...
                ('auto_purchased', models.BooleanField(blank=True, default=False, null=True)),
                ('already_alerted', models.BooleanField(blank=True, default=False, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Position',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address_to_transfer_to', models.TextField(blank=True, default='', null=True)),
                ('fiat_loan_amount', models.FloatField(default=0)),
                ('dex_token_contract', models.TextField(blank=True, default='', null=True)),
                ('uuid', models.TextField(blank=True, default='', null=True)),
                ('name', models.TextField(blank=True, default='', null=True)),
                ('epoch_created', models.BigIntegerField(default=0)),
                ('epoch_updated', models.BigIntegerField(default=0)),
